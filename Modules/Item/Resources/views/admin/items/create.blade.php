...
@section('content')
    {!! Form::open(['route' => ['admin.item.item.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('item::admin.items.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
